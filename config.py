...
OWNER_ID = int(getenv("OWNER_ID", 6028855169))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Santanuxmusic/SYSTUM",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/chilekothaisanumusic")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/chilekothai_Sanu_music")
